...
app = Flask(__name__)
model = joblib.load(r"C:\Users\jayes\Documents\JB_Files\study\SEP2022\Student Mark Predictor Project Deployment\Student mark Predictor Deployment\student_mark_predictor.pkl")
